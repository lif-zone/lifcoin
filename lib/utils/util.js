...
util.OF = o=>o ? Object.entries(o) : [];

util.obj_find = function obj_find(o, fn){
  return Object.entries(o).find(([k, v])=>fn(k, v));
};

util.crit_err = function crit_err(err){
